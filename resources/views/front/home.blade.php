            ...
            <div class="row" data-aos="fade-up">
                <div class="col-xl-8 stretch-card grid-margin">
                    <div class="position-relative">
                        <img src="{{ asset('back/images/dashboard/banner.jpg') }}" alt="banner" class="img-fluid" />
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex border-bottom-blue pt-3 pb-4 align-items-center justify-content-between">
                                ...
                                <div class="rotate-img">
                                    <img src="{{ asset('back/images/dashboard/home_1.jpg') }}" alt="thumb"
                            ...
                            <div class="d-flex border-bottom-blue pb-4 pt-4 align-items-center justify-content-between">
                                ...
                                <div class="rotate-img">
                                    <img src="{{ asset('back/images/dashboard/home_2.jpg') }}" alt="thumb"
                                        class="img-fluid img-lg" />
                                </div>
                            </div>
                            ...
                            <div class="d-flex pt-4 align-items-center justify-content-between">
                                ...
                                <div class="rotate-img">
                                    <img src="{{ asset('back/images/dashboard/home_3.jpg') }}" alt="thumb"
                                        class="img-fluid img-lg" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4 grid-margin">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img src="{{ asset('back/images/dashboard/home_4.jpg') }}" alt="thumb"
                                                class="img-fluid" />
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 grid-margin">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img src="{{ asset('back/images/dashboard/home_5.jpg') }}" alt="thumb"
                                                class="img-fluid" />
                                        </div>
                                        <div class="badge-positioned">
                                            <span class="badge badge-danger font-weight-bold">Flash news</span>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img src="{{ asset('back/images/dashboard/home_6.jpg') }}" alt="thumb"
                                                class="img-fluid" />
                                        </div>
                                        <div class="badge-positioned">
                                            <span class="badge badge-danger font-weight-bold">Flash news</span>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 grid-margin">
                                            <div class="position-relative">
                                                <div class="rotate-img">
                                                    <img src="{{ asset('back/images/dashboard/home_7.jpg') }}"
                                        ...
                                        <div class="col-sm-6 grid-margin">
                                            <div class="position-relative">
                                                <div class="rotate-img">
                                                    <img src="{{ asset('back/images/dashboard/home_8.jpg') }}"
                                                        alt="thumb" class="img-fluid" />
                                                </div>
                                                <div class="badge-positioned w-90">
                                                    <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 grid-margin">
                                            <div class="position-relative">
                                                <div class="rotate-img">
                                                    <img src="{{ asset('back/images/dashboard/home_9.jpg') }}"
                                                        alt="thumb" class="img-fluid" />
                                                </div>
                                                <div class="badge-positioned w-90">
                                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="col-sm-6 grid-margin">
                                            <div class="position-relative">
                                                <div class="rotate-img">
                                                    <img src="{{ asset('back/images/dashboard/home_10.jp') }}g"
                                                        alt="thumb" class="img-fluid" />
                                                </div>
                                                <div class="badge-positioned w-90">
                                                    <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img src="{{ asset('back/images/dashboard/home_11.jp') }}g"
                                                    alt="thumb" class="img-fluid" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom pt-3 pb-2">
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img src="{{ asset('back/images/dashboard/home_12.jp') }}g"
                                                    alt="thumb" class="img-fluid" />
                                            </div>
                                        </div>
                                        <h3 class="font-weight-600 mb-0">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom pt-3 pb-2">
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img src="{{ asset('back/images/dashboard/home_13.jp') }}g"
                                                    alt="thumb" class="img-fluid" />
                                            </div>
                                        </div>
                                        <h3 class="font-weight-600 mb-0">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom pt-3 pb-2">
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img src="{{ asset('back/images/dashboard/home_14.jp') }}g"
                                                    alt="thumb" class="img-fluid" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-3">
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img src="{{ asset('back/images/dashboard/home_15.jp') }}g"
                                                    alt="thumb" class="img-fluid" />
                                            </div>
                                        </div>
                                        <h3 class="font-weight-600 mb-0">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-8 col-sm-6">
                                            <div class="rotate-img">
                                                <img src="{{ asset('back/images/dashboard/home_16.jp') }}g"
                                                    alt="thumb" class="img-fluid" />
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="border-bottom pb-3">
                                                <div class="rotate-img">
                                                    <img src="{{ asset('back/images/dashboard/home_17.jp') }}g"
                                                        alt="thumb" class="img-fluid" />
                                                </div>
                                            ...
                                            <div class="pt-3 pb-3">
                                                <div class="rotate-img">
                                                    <img src="{{ asset('back/images/dashboard/home_18.jp') }}g"
                                                        alt="thumb" class="img-fluid" />
                                                </div>
                                                <p class="fs-16 font-weight-600 mb-0 mt-3">
                                                    Kaine: Trump Jr. may have
                                                    ...
                                                    <div class="border-bottom pb-3">
                                                        <div class="row">
                                                            <div class="col-sm-5 pr-2">
                                                                <div class="rotate-img">
                                                                    <img src="{{ asset('back/images/dashboard/home_19.jp') }}g"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="border-bottom pb-3 pt-3">
                                                        <div class="row">
                                                            <div class="col-sm-5 pr-2">
                                                                <div class="rotate-img">
                                                                    <img src="{{ asset('back/images/dashboard/home_20.jp') }}g"
                                                                        alt="thumb" class="img-fluid w-100" />
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-7 pl-2">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="border-bottom pb-3 pt-3">
                                                        <div class="row">
                                                            <div class="col-sm-5 pr-2">
                                                                <div class="rotate-img">
                                                                    <img src="{{ asset('back/images/dashboard/home_21.jp') }}g"
                                                                        alt="thumb" class="img-fluid w-100" />
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-7 pl-2">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="pt-3">
                                                        <div class="row">
                                                            <div class="col-sm-5 pr-2">
                                                                <div class="rotate-img">
                                                                    <img src="{{ asset('back/images/dashboard/home_22.jp') }}g"
                                                                        alt="thumb" class="img-fluid w-100" />
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-7 pl-2">
